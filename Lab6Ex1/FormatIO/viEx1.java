...
public class viEx1 {
	...
	public static void main (String[] arg) 
	{
		...
		int totalCost40 = 40 * cost1 + delivery;
		
		
	    if (num >= 40 ) {
			 	
		 		totalCost = totalCost + (10/100 * totalCost); //applies 10% discount when 40 or more items ordered
		 	    String userDiscAlert = "You qualify for a 10% discount because you are buying 40 or more items!";
		 	    con.println(userDiscAlert);
		 	}
		 		
	         else if ((num < 40) && (totalCost >= totalCost40)) {
		 		
		 		int freeItems = 40 - num;
		 		num = num + freeItems;
		 		String freeItemMess = freeItems + "" + itemName + "s have been added to your basket at no extra cost!\n";
		 		con.print(freeItemMess);
